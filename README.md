...
git clone [https://github.com/wictorianx/kickarr.git](https://github.com/wictorianx/kickarr.git)
cd kickarr
...
To run KickArr as a background service that starts automatically on boot:
    ...
    Edit kickarr.service and update the WorkingDirectory and ExecStart paths to match your local installation.
